...
const GAMES_DATA = [
  {
    ...
    iconBorder: "1px solid rgba(0,200,240,0.25)",
  },
  {
    name: "Fix It",
    id: "fix-it",
    icon: "🟡",
    desc: "Find the single error in a broken sentence before other teams. Race and Auction modes.",
    energy: "mid",
    phone: true,
    skill: "vocabulary",
    iconBg: "rgba(255,200,67,0.12)",
    iconBorder: "1px solid rgba(255,200,67,0.25)",
  },
  {
    name: "Odd One Out",
    id: "odd-one-out",
    ...
    phone: true,
    skill: "vocabulary",
    iconBg: "rgba(176,110,255,0.12)",
    iconBorder: "1px solid rgba(176,110,255,0.25)",
  },
  {
    name: "Jeopardy",
    id: "jeopardy",
    icon: "⊞",
    desc: "The classic 5×5 board. AI dynamically generates categories and high-context visual aids.",
    energy: "mid",
    phone: true,
    skill: "reading",
    iconBg: "rgba(0,232,122,0.12)",
    iconBorder: "1px solid rgba(0,232,122,0.25)",
  },
  {
    name: "The Hot Seat",
    id: "hotseat",
    ...
    phone: false,
    skill: "speaking",
    iconBg: "rgba(255,125,59,0.12)",
    iconBorder: "1px solid rgba(255,125,59,0.25)",
  },
  {
    name: "Picture Reveal",
    id: "reveal",
  ...
  },
  {
    ...
    phone: true,
    skill: "writing",
    iconBg: "rgba(255,77,143,0.12)",
    iconBorder: "1px solid rgba(255,77,143,0.25)",
  },
  {
    name: "Story Chain",
    id: "story",
...
export default function GamesHub() {
  ...
  const featuredHistory =
    classHistory[activeClass?.name ?? "global"] ?? classHistory["global"];
  const featuredGame = GAMES_DATA[featIdx];

  const barColor =
    featuredHistory.accuracy >= 70
      ? "var(--green)"
      : featuredHistory.accuracy >= 50
        ? "var(--yellow)"
        : "var(--pink)";
  const valClass =
    featuredHistory.accuracy >= 70
      ...
      <div className={styles.pageHeader}>
        <div style={{ position: "relative", zIndex: 2 }}>
          <div className={styles.breadcrumb}>
            SYSTEM_ONLINE // <span>MISSION_SELECT</span>
          </div>
        ...
        >
          ...
          <BoardLibrary
            ...
            onLoadBoard={(b) => handleLaunch(`/${b.gameType}`)}
      ...
      <div className={styles.view}>
        <div className={styles.featuredWrapper}>
          ...
          <div className={styles.classChipRow}>
            ...
            <a
              href="/teams"
              className={`${styles.classChip} ${styles.classChipManage}`}
            >
              + Manage
            </a>
          </div>
          ...
          <div
            ...
            onClick={() => handleLaunch(`/${featuredGame.id}`)}
          >
            <div
              className={styles.featuredBanner}
              style={{
                backgroundImage: `url(/games/${featuredGame.id}-large.png)`,
              }}
            />
            <div style={{ position: "relative", zIndex: 5, flex: 1 }}>
                ...
                <div>
                  ...
                  >
                    ...
                    <strong style={{ color: "var(--text)" }}>
                      {featuredHistory.when}
                    </strong>{" "}
                    · {featuredHistory.className}
                  </div>
                </div>
              </div>
              ...
              <div className={styles.featuredTags}>
                <span
                  className={`${styles.tag} ${featuredGame.energy === "high" ? styles.tagEnergyHigh : featuredGame.energy === "mid" ? styles.tagEnergyMid : styles.tagEnergyLow}`}
                >
                  {featuredGame.energy === "high"
                    ? "🔥 High Energy"
                    : featuredGame.energy === "mid"
                      ? "⚡ Mid Energy"
                      : "💧 Low Energy"}
                </span>
                {featuredGame.phone && (
                  <span className={`${styles.tag} ${styles.tagPhone}`}>
                    📱 Phone Active
                  </span>
                )}
                <span
                  className={`${styles.tag} ${styles.tagSkill}`}
                  style={{ backgroundColor: featuredGame.iconBg }}
                >
                  {featuredGame.skill}
                </span>
              </div>
              ...
              <div className={styles.sessionStats}>
                <div className={styles.statItem}>
                  ...
                  <div className={`${styles.statValue} ${valClass}`}>
                    {featuredHistory.score.toLocaleString()}
                  </div>
                </div>
                ...
                <div className={styles.statBarWrap}>
                  ...
                  <div className={styles.statBarTrack}>
                    <div
                      ...
                      style={{
                        width: `${featuredHistory.accuracy}%`,
                        background: barColor,
                      }}
                    ></div>
                  </div>
                ...
                <div className={styles.statItem}>
                  ...
                  <div
                    ...
                    style={{
                      color:
                        featuredHistory.deltaDir === "up"
                          ? "var(--green)"
                          : "var(--pink)",
                    }}
                  >
                    {featuredHistory.deltaDir === "up" ? "↑" : "↓"}{" "}
                    {featuredHistory.delta}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              className={styles.featuredLaunch}
              ...
              >
                <svg width="34" height="34" className={styles.cycleSvg}>
                  <circle
                    ...
                    cy="17"
                    r="15"
                    className={styles.cycleCircleBg}
                  />
                  <circle
                    cx="17"
                    cy="17"
        ...
        <div className={styles.filterBar}>
          {["all", "vocabulary", "reading", "writing", "speaking", "phone"].map(
            (f) => (
              <button
                key={f}
          ...
          {["vocabulary", "reading", "writing", "speaking"].map((skill) => {
            ...
            const textClass =
              skill === "vocabulary"
                ? styles.catVocabText
                : skill === "reading"
                  ? styles.catReadingText
                  : skill === "writing"
                    ? styles.catWritingText
                    : styles.catSpeakingText;

            return (
              <div key={skill} className={styles.categoryBlock}>
                <div className={styles.categoryHeader}>
                  <div className={`${styles.categoryIcon} ${catClass}`}>
                    {icon}
                  </div>
                  <div className={`${styles.categoryTitle} ${textClass}`}>
                    {skill}{" "}
                  ...
                  {catGames.map((g) => (
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundImage: `url(/games/${g.id}-small.png)`,
                        }}
                      />
                      <div
                      ...
                      <div
                        className={styles.gameCardFooter}
                        style={{ position: "relative", zIndex: 5 }}
                      >
                        <div className={styles.gameCardTags}>
                          <span
                            className={`${styles.tag} ${g.energy === "high" ? styles.tagEnergyHigh : g.energy === "mid" ? styles.tagEnergyMid : styles.tagEnergyLow}`}
                          >
                            {g.energy}
                          </span>
                          {g.phone && (
                            <span
                              className={`${styles.tag} ${styles.tagPhone}`}
                            >
                              📱
                            </span>
                          )}
          ...
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            >
              ...
              {llmProvider === "lmstudio" && (
                ...
                >
                  LM Studio runs locally — no API key needed. Make sure the
                  server is running on{" "}
                  <strong style={{ color: "var(--green)" }}>port 1234</strong>.
                </div>
              )}
            </div>
